...
/////////////////////////////////////////////////////////////////////////////
typedef enum      {TXSELECT,TXCREATE,TXINSERT,TXUPDATE,TXDELETE,TXDROP,TXFROM,TXINTO,TXWHERE,TXSHOW,TXORDER,TXBY,TXSET,TXLIMIT,TXTABLES,TXTBL  ,TXDATABASES,TXDATABASE,TXVALUES,TXQUIT,TXUSE,TXAND,TXOR,TXAS,TXHELP,TXASC,TXDESC,TXPS,TXPE,TXCM,TXED,TXOP,TXARG=99,TXPRM=98,TXNONE=-1,TXOTHER=-2} CTYP;
//extern char   ccmd[][10]={"select","create","insert","update","delete","drop","from","into","where","show","order","by","set","limit","tables","table","databases","database","values","quit","use","and","or","as","help","asc","desc"};
//extern CTYP   ctyp[]={TXSELECT,TXCREATE,TXINSERT,TXUPDATE,TXDELETE,TXDROP,TXFROM,TXINTO,TXWHERE,TXSHOW,TXORDER,TXBY,TXSET,TXLIMIT,TXTABLES,TXTBL  ,TXDATABASES,TXDATABASE,TXVALUES,TXQUIT,TXUSE,TXAND,TXOR,TXAS,TXHELP,TXASC,TXDESC};
...
public:
    ...
    ~Database(void);
    ////////////////////////////////////////////////////////////////////////////
    int SQL(const wString& sqltext,view*& vw);
    ////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////
    //データベースに接続する
    Database* DBConnect(wString& DBName);
    ////////////////////////////////////////////////////////////////////////////
    //データベースを閉じる
    int DBClose(Database* db);
    ////////////////////////////////////////////////////////////////////////////
    //新規にDB作成
    Database* DBCreate(wString DBName);
    ////////////////////////////////////////////////////////////////////////////
    //DBクローズ
    void DBClose(wString& DBName);
    ////////////////////////////////////////////////////////////////////////////
