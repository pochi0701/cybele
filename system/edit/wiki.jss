...
function htmlHeader( title, config )
{
    ...
    print("  <link href=\"http://netdna.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css\" rel=\"stylesheet\">\n");
    ...
    print("  <script src=\"http://netdna.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js\"></script>\n");
    print("</head>\n");
    print("<body>\n");
...
function htmlFooter()
{
    ...
    print( "        Copyright(c) 2016 <a href=\"http://www.birdland.co.jp\">Birdland Ltd.</a> All Rights Reserved.\n");
    print( "      </p>\n");
    print( "    </div>\n");
    print( "  </body>\n");
    print( "</html>\n");
